 ...
 * La encuesta física tiene 4 páginas fotografiables. Cada página contiene
 * "campos": o bien un campo de información general (checkbox único, o texto
 * manuscrito), o bien una fila de escala (un grupo de opciones excluyentes
 * marcadas con X o con un círculo/aspa).
 *
...
const page1: SurveyPageTemplate = {
  ...
  description: 'Encabezado "Encuesta salud integral", código en la esquina superior derecha, preguntas 1 a 6',
  fields: [
...
// ---------------------------------------------------------------------------
// PÁGINA 2 — "Mi sufrimiento..." (1-11) + Seguridad alimentaria (12-17) + Autoeficacia (18-21)
// ---------------------------------------------------------------------------
const page2: SurveyPageTemplate = {
  pageNumber: 2,
  title: 'Sufrimiento, alimentación y autoeficacia',
  description: 'Desde "Mi sufrimiento es un reflejo..." (fila 1) hasta "...seguir con una dieta saludable" (fila 21)',
  fields: [
...
// ---------------------------------------------------------------------------
// PÁGINA 4 — Paz (5-7 visibles, se asume 1-7) + calificación general (8-16) + estrés (17)
// ---------------------------------------------------------------------------
